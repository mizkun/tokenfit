...
const COPY = {
  en: {
    ...
    remind: (challenge, lang) => `⏳ Still owed: ${challengeLine(challenge, lang)} → /tf done (or /tf skip, or /tf how)`,
  ...
  ja: {
    ...
    remind: (challenge, lang) => `⏳ 未消化: ${challengeLine(challenge, lang)} → /tf done か /tf skip（手順は /tf how）`,
