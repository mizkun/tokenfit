...
export const EXERCISES = [
  ...
  },
  {
    ...
    en: {
      ...
      steps: [
        'Stand with your back to the desk and grip its edge behind you.',
        'Walk your feet forward so your arms carry some of your weight.',
        'Bend your elbows slightly, then press back up. Skip it if the desk wobbles.'
      ]
    },
    ja: {
      name: 'デスクディップス',
  ...
  },
  {
    ...
    en: {
      name: 'Hip hinges',
      target: 'Hamstrings',
      cue: 'A slow bow: hips back, back flat.',
      steps: [
